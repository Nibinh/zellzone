...
function App() {
  return (
    ...
    <Routes>
      ...
      <Route path='/profile/:eml' element={<Profile/>}/>
      ...
      <Route path='/profileprodcardview/:id' element={<Profileprodcardview/>}/>
      <Route path='/homeprodview/:id' element={<Homeprodview/>}/>
      <Route path='/Wishlistdisplaying/:eml' element={<Wishlistdisplaying/>}/>
      <Route path='/Wishlistproductdetail/:id' element={<Wishlistproductdetails/>}/>
      <Route path='/profileProductslist' element={<ProfileProductslist/>}/>
      <Route path='/adminallproddetailsdisp/:id' element={<Adminallproddetailsdisp/>}/>
      <Route path='/edit/:eml' element={<Edit/>}/>
