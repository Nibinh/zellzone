...
<Container className='mt-5 ' >
        ...
        <Row style={{marginTop:'120px',marginBottom:'433px'}}>
           ...
           <div>
              <h1 className='produnctsfont'>All Products<i class="ms-2 fa-solid fa-users"></i></h1>
...
{allproduct.length>0?(
   ...
   {user&&( <div className='mt-5'>
     ...
     allproduct.filter((data)=> {
         ...
         <td className='px-3 textfonts'>{data.age}</td>
         <td className='px-3 textfonts'>{data.price} Rs</td>
         <td className='px-3 text-center'>
        <Link to={'/adminallproddetailsdisp/'+data.Id}> <Button className='' style={{backgroundColor:'limegreen'}}><i class="fa-solid fa-eye"></i></Button></Link >
...
):(<h1 className='text-center mt-5 noitemsmsg'>No Products yet! <i class="fa-thin fa-empty-set"></i></h1>)
 }
            </Col>
        </Row>
    </Container>
