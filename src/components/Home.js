    ...
    <div>
      ...
      <div id="home" className="displaypic">
        <Row className="displaypicdetails ">
          <Col lg={3}>
            <h1 className="headDisplay animate__animated animate__slideInLeft">
              Hello...
            </h1>
            <p className="headDisplayparaa headDisplaypara animate__animated animate__slideInLeft">
              Welcome to our online marketplace where you can both buy and sell
              items with ease!
            </p>
          </Col>
          <Col lg={9}></Col>
          ...
          <Col className="mt-4 p-5 aboutpara headDisplaypara" lg={5}>
            <div>
              ...
              <p className="headDisplaypara">
                As a seller, you can showcase your products to a large audience
                of potential buyers. Simply create an account and list your
                items for sale with detailed descriptions and high-quality
                images. You can also set your own prices and manage your sales
      ...
      <div id="product" className="mb-5">
        <div className="text-center mt-5 searchset">
          <div>
            <h2 className="produnctsfont">
              Products<i class="ms-2 fa-solid fa-bag-shopping"></i>
            </h2>
            <Form.Group
